...
def getListForFamily(ddi):
	...
	summaryFileName=Folder+ddi+'/precisionVector.txt'
	try:
...
print 'The average precision of the %d ddis at family level is %f' % (numberOfSuccessDDI, numpy.average(listTotalFamily))
print 'The standard deviation  of precision at family level is %f' % numpy.std(listTotalFamily)
