...
def getListForTopology(ddi):
	...
	for topology in topologyList:
		summaryFileName=Folder+ddi+'/'+topology+'/MCCVector.txt'
		...
		try:	
			...
			print 'This ddi '+ddi+topology+'does not have MCCVector.txt'
			return False
	return data
#start
todoList=sys.argv[1]
...
print 'The average MCCVector of the %d ddis at topology level is %f' % (numberOfSuccessDDI, numpy.average(listTotalTopology))
print 'The standard deviation  of MCCVector at topology level is %f' % numpy.std(listTotalTopology)
