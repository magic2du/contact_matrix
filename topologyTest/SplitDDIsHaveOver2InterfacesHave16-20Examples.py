...
Folder='/home/du/topologyTest/dom_dom_ints/'# set the working folder
...
for ddi in ddiList:
	...
	for val in rTopology[0:]:
		...
		if int(numExample[0][0])>15 and int(numExample[0][0])<=20:# if 16-20 example creat fold and split
			...
			writeSplit(didOriginal,domain1+'_int_'+domain2,topologyFolder,Examples)
