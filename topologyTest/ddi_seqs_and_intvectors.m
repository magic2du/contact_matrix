function ddi_seqs_and_intvectors(ddi_folder)

% load the ddi struct.
folder3did = '/home/du/Protein_Protein_Interaction_Project/3did_15OCT2010/topologyTest/dom_dom_ints/';
ddi_str_file = [folder3did ddi_folder '/ddi_str_array.mat'];
load(ddi_str_file);
...
% write fasta files.
fasta_fileA = [folder3did ddi_folder '/domASeqs.fasta'];
...
fasta_fileB = [folder3did ddi_folder '/domBSeqs.fasta'];
...
domA_AADistFile = [folder3did ddi_folder '/domA_AADistrib'];
save(domA_AADistFile, 'domA_AADistrib');
domB_AADistrib = aacount(domBLongSeq);
domB_AADistFile = [folder3did ddi_folder '/domB_AADistrib'];
