function         [SimilarityVector, recallVector, specificityVector, precisionVector, accuracyVector, F1Vector, MCCVector, scoreVector]=predictContactsFamilyLevel_singleDDI_2010(ddi_folder,ddi_str_array)
