...
def getListForFamily(ddi):
	...
	summaryFileName=Folder+ddi+'/specificityVector.txt'
	try:
...
def getListForTopology(ddi):
	...
	for topology in topologyList:
		summaryFileName=Folder+ddi+'/'+topology+'/specificityVector.txt'
		...
		try:	
			...
			print 'This ddi '+ddi+topology+'does not have specificityVector.txt'
			return False
	return data
#start
todoList=sys.argv[1]
...
print 'The average specificity of the %d ddis at family level is %f' % (numberOfSuccessDDI, numpy.average(listTotalFamily))
print 'The standard deviation  of specificity at family level is %f' % numpy.std(listTotalFamily)
...
print 'The average specificity of the %d ddis at topology level is %f' % (numberOfSuccessDDI, numpy.average(listTotalTopology))
print 'The standard deviation  of specificityV at topology level is %f' % numpy.std(listTotalTopology)
