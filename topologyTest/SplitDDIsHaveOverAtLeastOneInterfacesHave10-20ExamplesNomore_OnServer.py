...
#Number of Domains which has 2 interfaces have more than 9 examples
SUCCESS=[]
for ddi in ddiList:
   	[domain1,domain2]=ddi
	...
	for val in rTopology[0:]:
		...
		try:
			...
			if int(numExample[0][0])>=10 and int(numExample[0][0])<=20:# if 10-20 example creat fold and split
