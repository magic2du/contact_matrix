function    [SimilarityVector, recallVector, specificityVector, precisionVector, accuracyVector, F1Vector, MCCVector, scoreVector]=predictContactsTopologyLevel_singleDDI_2010_LOO(ddi_folder,ddi_str_array)
