...
def getListForFamily(ddi):
	...
	summaryFileName=Folder+ddi+'/accuracyVector.txt'
	try:
...
def getListForTopology(ddi):
	...
	for topology in topologyList:
		summaryFileName=Folder+ddi+'/'+topology+'/accuracyVector.txt'
		...
		try:	
			...
			print 'This ddi '+ddi+topology+'does not have accuracyVector.txt'
			return False
	return data
#start
todoList=sys.argv[1]
...
print 'The average accuracyV of the %d ddis at family level is %f' % (numberOfSuccessDDI, numpy.average(listTotalFamily))
print 'The standard deviation  of accuracy at family level is %f' % numpy.std(listTotalFamily)
...
print 'The average accuracy of the %d ddis at topology level is %f' % (numberOfSuccessDDI, numpy.average(listTotalTopology))
print 'The standard deviation  of accuracy at topology level is %f' % numpy.std(listTotalTopology)
