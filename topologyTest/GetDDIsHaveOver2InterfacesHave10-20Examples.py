...
for ddi in ddiList:
	...
	for val in rTopology[0:]:
            ...
            try:
                ...
                break            
            if int(numExample[0][0])>9:# if for those interfaces have more than 15 examples if they have less than 21 examples, add it.
...
writeListFile('listOfDDIsHaveOver2InterfacesHave10-20Examples.txt',ddis)
