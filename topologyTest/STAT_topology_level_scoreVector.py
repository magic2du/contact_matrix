...
def getListForFamily(ddi):
	...
	summaryFileName=Folder+ddi+'/scoreVector.txt'
	try:
		...
		print 'This ddi '+ddi+' does not have scoreVector.txt'
		return False
def getListForTopology(ddi):
	...
	for topology in topologyList:
		summaryFileName=Folder+ddi+'/'+topology+'/scoreVector.txt'
		...
		try:	
			...
			print 'This ddi '+ddi+topology+'does not have scoreVector.txt'
			return False
	return data
#start
todoList=sys.argv[1]
...
print 'The average score of the %d ddis at family level is %f' % (numberOfSuccessDDI, numpy.average(listTotalFamily))
print 'The standard deviation  of score at family level is %f' % numpy.std(listTotalFamily)
...
print 'The average score of the %d ddis at topology level is %f' % (numberOfSuccessDDI, numpy.average(listTotalTopology))
print 'The standard deviation  of score at topology level is %f' % numpy.std(listTotalTopology)
