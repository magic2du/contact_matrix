...
ddiName='PF00028.9_int_PF00028.9';
...
[trainData , trainLabels, mu, whMat]=processRawData(trainFilePath, true);
...
%[testData , testLabels]=processTestData(testFilePath, mu, whMat, false);
%testData=testData';
testData=trainData;
