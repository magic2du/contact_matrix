function stackedAE_DDI_f2(ddiName, hiddenSizeL1, hiddenSizeL2, trainRand, testRand, maxIteration)
...
[trainData , trainLabels, mu, whMat]=processRawData(trainFilePath, trainRand);
...
[testData , testLabels]=processTestData(testFilePath, mu, whMat, testRand);
testData=testData';
