...
import random
from DL_libs_backup_01162015 import *
...
settings['fisher_mode'] = 'FisherM1ONLY'
...
settings['training_epochs'] = 20000
        ...
        def get_LOO_perfermance(self, settings = None):
            ...
            for seq_no in range(1, self.ddi_obj.total_number_of_sequences+1):
                ...
                if 0:
                    ...
                    pretraining_epochs_for_reduced = cal_epochs(training_epochs, pretraining_X_minmax, batch_size = batch_size)
...
class Ten_fold_crossvalid_performance_for_one_ddi(object):
        ...
        def get_ten_fold_crossvalid_perfermance(self, settings = None):
            ...
            report_name = filename + '_' + '_test10fold_'.join(map(str, hidden_layers_sizes)) +                             '_' + str(pretrain_lr) + '_' + str(finetune_lr) + '_' + str(reduce_ratio)+                     '_' + str(settings['training_epochs']) + '_' + current_date
