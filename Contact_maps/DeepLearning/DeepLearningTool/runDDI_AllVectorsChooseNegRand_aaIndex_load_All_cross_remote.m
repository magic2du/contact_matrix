...
elseif strcmp(SVMMode, 'DL')
    ...
    [trainResult, testResult]= SAE_AllVectorsChooseNegRand_aaIndex_load_All_cross_remote(trainData, trainLabel, POTestWhole, NETestWhole, POTest, NETest, pairsToRun);
