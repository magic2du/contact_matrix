function [trainResult, testResult]= SAE_AllVectorsChooseNegRand_aaIndex_load_All_cross(trainData, trainLabel, POTestWhole, NETestWhole, POTest, NETest, pairsToRun)
...
weightPenaltyL2=0; %default 1.00e-3
learningRate= 0.01; %default is 1
dropoutFraction=0.5; %default is 0
nonSparsityPenalty=3; %default is 3
...
if 1
    rng(0);
    sae = saesetup([numberOFFeature hiddenUnits hiddenUnits hiddenUnits hiddenUnits]);
    sae.ae{1}.activation_function       = 'sigm';
    sae.ae{1}.learningRate              = learningRate;
    sae.ae{1}.weightPenaltyL2           = weightPenaltyL2;
    sae.ae{1}.nonSparsityPenalty        = nonSparsityPenalty;
    ...
    sae.ae{3}.nonSparsityPenalty        = nonSparsityPenalty;
    ...
    sae.ae{4}.nonSparsityPenalty        = nonSparsityPenalty;
    ...
    % Use the SDAE to initialize a FFNN
    nn = nnsetup([numberOFFeature hiddenUnits hiddenUnits hiddenUnits hiddenUnits 1]);
    nn.activation_function              = 'sigm';
    nn.learningRate                     = learningRate;
    nn.weightPenaltyL2                  = weightPenaltyL2;
    nn.dropoutFraction                  = dropoutFraction;
