function run3DID_AllVectorsChooseNegRand_aaIndex_load_All_cross_remote( ...
...
logfile_name = ['log_run3DID_AllVectorsChooseNegRand_aaIndex_load_All_cross_remote_' ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% get examples.
MatrixFile=[folder3did 'Family_' FisherMode '.mat' ];
...
parfor ddi_ctr = 1:length(cell_ddis)
    ...
    try
        ...
        [aucBL_Array, blSens_Array, blSpec_Array, ...
                    ...
                    trainAccuracy_Array, trainRecall_Array, trainPrecision_Array, train_f_measure_Array]  = runDDI_AllVectorsChooseNegRand_aaIndex_load_All_cross_remote ...
