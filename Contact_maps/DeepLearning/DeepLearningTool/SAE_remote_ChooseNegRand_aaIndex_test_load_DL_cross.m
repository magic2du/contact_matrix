function [trainResult, testResult]= SAE_remote_ChooseNegRand_aaIndex_test_load_DL_cross(trainData, trainLabel, testData, testLabel)
addpath(genpath('/home/du/Protein_Protein_Interaction_Project/Contact_Matrix_Project/DeepLearning/'));
