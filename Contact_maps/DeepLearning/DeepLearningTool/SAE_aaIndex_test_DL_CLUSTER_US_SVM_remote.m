function [trainResult, testResultOnReducedModel, testResultOnUSModel] = SAE_aaIndex_test_DL_CLUSTER_US_SVM_remote(trainData, trainLabel, testData, testLabel, reducedTrainingData, reducedTrainingLabel, ddiPath)
...
newTrainX=getNewRepresentationOfX(nn, scaled_reduced_x, reduced_y);
newTestX=getNewRepresentationOfX(nn, test_x, testLabel);
[trainResult, testResult]=runSVMLight(newTrainX,reduced_y, newTestX, testLabel, ddiPath); 
testResultOnUSModel=testResult;
testResultOnReducedModel=testResult;
