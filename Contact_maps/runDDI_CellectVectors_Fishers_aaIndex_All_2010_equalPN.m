function runDDI_CellectVectors_Fishers_aaIndex_All_2010_equalPN(ddiName, outputPath)
...
for pairCtr = 1:length(pairsToRun)
    ...
    [TrainingV, numPos, numNeg] = runSeqPair_CellectVectors_Fishers_aaIndex_All_2010_equalPN( ...
        ddiName, testPair);
