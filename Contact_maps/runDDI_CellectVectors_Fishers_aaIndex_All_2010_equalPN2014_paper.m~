function runDDI_CellectVectors_Fishers_aaIndex_All_2010_equalPN2014_paper(ddiName, outputPath)
...
for pairCtr = 1:length(pairsToRun)
    ...
    [TrainingV, numPos, numNeg] = runSeqPair_CellectVectors_Fishers_aaIndex_All_2010_equalPN2014( ...
        ddiName, testPair);
	filename=[outputPath 'F0_20_F1_20_Sliding_17_11_F0_20_F1_20_Sliding_17_11_ouput_' num2str(testPair) '.txt']
