function run3DID_CellectVectors_Fishers_aaIndex_All_Dec3(file_ddis)
...
logfile_name = ['log_run3DID_CellectVectors_Fishers_aaIndex_All_Dec3' ...
             dateFormatted '.txt'];
...
parfor ddi_ctr = 1:length(cell_ddis)
    ...
    try
        ...
        runDDI_CellectVectors_Fishers_aaIndex_All_Dec3(ddiName, outputPath);
