function ContactMapsOn3DID_2014_new(file_ddis)
...
logfile_name = ['log_ContactMapsOn3DID_2014_' dateFormatted '.txt'];
...
if ~exist('ContactMapExamples_2014', 'dir')
    mkdir('ContactMapExamples_2014');
end
