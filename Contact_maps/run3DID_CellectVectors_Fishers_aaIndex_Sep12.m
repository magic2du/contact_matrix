function run3DID_CellectVectors_Fishers_aaIndex_Sep12(file_ddis)
...
logfile_name = ['log_run3DID_CellectVectors_Fishers_aaIndex_Sep12' ...
             dateFormatted '.txt'];
...
for ddi_ctr = 1:length(cell_ddis)
    ...
    try
        ...
        runDDI_CellectVectors_Fishers_aaIndex_Sep12(ddiName, outputPath);
