function [V, numPos, numNeg] = runSeqPair_CellectVectors_Fishers_aaIndex_equalPN2014_paper ...
                        (ddiName, pairNbr)
%function auc = runSeqPairAllVectorsChooseNegRand_02NOV2011()

folder3did = ['/big/du/Protein_Protein_Interaction_Project/3did_Mar_16_2014/dom_dom_ints/'];
ddiPath = [folder3did ddiName '/'];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
contactMatrixPath = ...
        ['/home/du/Protein_Protein_Interaction_Project/Contact_Matrix_Project/ContactMapExamples_2014/' ...
...
hmmA = pfamhmmread(['/home/du/Protein_Protein_Interaction_Project/PFAM/Pfam27.0/SINGLE_FILES/' domA '.pfam']);
hmmB = pfamhmmread(['/home/du/Protein_Protein_Interaction_Project/PFAM/Pfam27.0/SINGLE_FILES/' domB '.pfam']);
