...
for ddi in ddiList:
    ...
    try:
        ...
        if int(numExample[0][0])>40 and int(numExample[0][0])<75 and domain1!=domain2:
            ddis.append(domain1+'_int_'+domain2)
    except:
        print 'error'
        break     
writeListFile('listOfDDIsHaveOver2InterfacesHave40-75_Examples_No_Same_Names_pseudo.txt',ddis)
