function run3DID_STAT_75_125_multipTop_examples_2010()
...
file_ddis='listOfDDIsHaveOver2InterfacesHave50-150_Examples_No_Same_Names_pseudo.txt';
diary off;
dateFormatted = upper(date);
dateFormatted = dateFormatted(regexp(upper(date), '[A-Z0-9]'));
logfile_name = ['log_run3DID_STAT_75_125_examples_2010' ...
             dateFormatted '.txt'];
