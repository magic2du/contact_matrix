function run3DID_AllVectorsChooseNegRand_aaIndex_test_load( ...
...
logfile_name = ['log_run3DID_AllVectorsChooseNegRand_aaIndex_test_load_' ...
...
for ddi_ctr = 1:length(cell_ddis)
    ...
    try
        ...
        [aucBL_Array, blSens_Array, blSpec_Array, ...
                    ...
                    trainAccuracy_Array, trainRecall_Array, trainPrecision_Array, train_f_measure_Array]  = runDDIAllVectorsChooseNegRand_aaIndex_test_load ...
