function run3DID_AllVectorsChooseNegRand_aaIndex_test_load_C_J( ...
                                            file_ddis, FisherMode, SVMMode, Kernel, choseNegRatio, choseNegRatioTest, C, Jj)

diary off;
dateFormatted = upper(date);
dateFormatted = dateFormatted(regexp(upper(date), '[A-Z0-9]'));
logfile_name = ['log_run3DID_AllVectorsChooseNegRand_aaIndex_test_load_C_J' ...
            FisherMode '_' SVMMode '_' Kernel '_' num2str(choseNegRatio) '_' num2str(choseNegRatioTest) '_' num2str(C) '_' num2str(Jj) '_' dateFormatted '.txt'];
...
fprintf('FisherMode: %s SVMMode: %s Kernel: %s, choseNegRatio: %d, choseNegRatioTest: %d C: %d J: %d\n', FisherMode, SVMMode, Kernel, choseNegRatio, choseNegRatioTest, C, Jj);
