function run3DID_STAT_40_70_multipTop_examples_2010()
...
file_ddis='listOfDDIsHaveOver2InterfacesHave40-75_Examples_No_Same_Names_pseudo.txt';
fid2=fopen('listOfDDIsHaveOver2InterfacesHave40-75_Examples_2010_real.txt', 'w'); 
diary off;
dateFormatted = upper(date);
dateFormatted = dateFormatted(regexp(upper(date), '[A-Z0-9]'));
logfile_name = ['log_run3DID_STAT_40_70_examples_2010' ...
             dateFormatted '.txt'];
