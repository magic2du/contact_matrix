function run3DID_STAT_200_250_examples_2010()
...
file_ddis='listOfFolders15OCT.txt';
diary off;
dateFormatted = upper(date);
dateFormatted = dateFormatted(regexp(upper(date), '[A-Z0-9]'));
logfile_name = ['log_run3DID_ STAT_200_250_examples_2010' ...
             dateFormatted '.txt'];
...
save('STAT_200_250_examples_2010.txt', 'ddisWith_200to250Examples', '-ascii' )
cd(currDir);
c = clock;
time = [num2str(c(1), '%0.0d') '-' num2str(c(2), '%0.0d') '-' ...
        num2str(c(3), '%0.0d') ' ' num2str(c(4), '%0.0d') ':' ...
